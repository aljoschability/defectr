...
/**
 * This is the item provider adapter for a {@link com.aljoschability.defectr.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addRawPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Category_raw_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Category_raw_feature", "_UI_Category_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				DefectrPackage.Literals.CATEGORY__RAW, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case DefectrPackage.CATEGORY__RAW:

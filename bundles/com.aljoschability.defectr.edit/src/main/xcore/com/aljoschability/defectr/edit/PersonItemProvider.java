...
import com.aljoschability.defectr.Person;
...
/**
 * This is the item provider adapter for a {@link com.aljoschability.defectr.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addMailPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_Person_mail_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Person_mail_feature", "_UI_Person_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				DefectrPackage.Literals.PERSON__MAIL, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				null, null));
	}
	...
	protected void addTitlePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Person_title_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Person_title_feature", "_UI_Person_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				DefectrPackage.Literals.PERSON__TITLE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Person) object).getMail();
	...
	public void notifyChanged(Notification notification) {
		...
		case DefectrPackage.PERSON__MAIL:
		case DefectrPackage.PERSON__TITLE:
